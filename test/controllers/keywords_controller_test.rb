...
class KeywordsControllerTest < ActionController::TestCase
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post :create, keyword: { interval: @keyword.interval, keyword: @keyword.keyword, max_tweet_id: @keyword.max_tweet_id, search_date: @keyword.search_date }
    end
  ...
  test "should update keyword" do
    patch :update, id: @keyword, keyword: { interval: @keyword.interval, keyword: @keyword.keyword, max_tweet_id: @keyword.max_tweet_id, search_date: @keyword.search_date }
    assert_redirected_to keyword_path(assigns(:keyword))
  end
